...
function collectAddFormErrors(): string[] {
  ...
  if (gross == null || gross <= 0)
    errs.push('Podaj dodatnią kwotę (netto lub brutto — reszta przeliczy się).')
      ...
      <DialogContent class="sm:max-w-lg">
        <form @submit.prevent="submitAdd">
          <DialogHeader>
            ...
            <DialogDescription>
              Kwoty w wybranym miesiącu (filtr u góry). Netto albo brutto —
              reszta zależy od stawki VAT.
            </DialogDescription>
          </DialogHeader>
          <div
            ...
            <div class="grid gap-4 sm:grid-cols-2">
              ...
              <div class="grid gap-2">
                ...
                <Input
                  ...
                  :class="
                    amountBasis === 'gross' ? 'bg-muted/50 text-muted-foreground' : ''
                  "
                />
              </div>
              <div class="grid gap-2">
              ...
              <div class="grid gap-2">
                ...
                <Input
                  ...
                  :class="
                    amountBasis === 'net' ? 'bg-muted/50 text-muted-foreground' : ''
                  "
                />
              </div>
