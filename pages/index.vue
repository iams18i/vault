          ...
          <Table v-if="data.recurring.items.length">
            ...
            <TableBody>
              <TableRow v-for="r in data.recurring.items" :key="r.id">
                ...
                <TableCell>
                  <Badge v-if="r.category" variant="secondary">{{
                    r.category
                  }}</Badge>
          ...
          <Table v-if="data.expenses.items.length">
            ...
            <TableBody>
              <TableRow v-for="e in data.expenses.items" :key="e.id">
                ...
                <TableCell>
                  <Badge v-if="e.category" variant="secondary">{{
                    e.category
                  }}</Badge>
                  <span v-else class="text-sm text-muted-foreground">—</span>
                </TableCell>
          ...
          <ul class="space-y-3 text-sm">
            ...
            >
              ...
              <span class="text-muted-foreground">
                ...
                <span
                  :class="t.remaining > 0 ? 'text-foreground font-medium' : ''"
